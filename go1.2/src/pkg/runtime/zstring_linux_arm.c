...
#line 12 "/home/pi/go_build/go/src/pkg/runtime/string.goc"
String runtime·emptystring; 
#line 14 "/home/pi/go_build/go/src/pkg/runtime/string.goc"
#pragma textflag NOSPLIT 
intgo 
runtime·findnull ( byte *s ) 
{ 
intgo l; 
#line 20 "/home/pi/go_build/go/src/pkg/runtime/string.goc"
if ( s == nil ) 
return 0; 
for ( l=0; s[l]!=0; l++ ) 
; 
...
#line 27 "/home/pi/go_build/go/src/pkg/runtime/string.goc"
intgo 
runtime·findnullw ( uint16 *s ) 
{ 
intgo l; 
#line 32 "/home/pi/go_build/go/src/pkg/runtime/string.goc"
if ( s == nil ) 
return 0; 
for ( l=0; s[l]!=0; l++ ) 
; 
...
#line 39 "/home/pi/go_build/go/src/pkg/runtime/string.goc"
uintptr runtime·maxstring = 256; 
#line 41 "/home/pi/go_build/go/src/pkg/runtime/string.goc"
static String 
...
#line 61 "/home/pi/go_build/go/src/pkg/runtime/string.goc"
String 
...
#line 73 "/home/pi/go_build/go/src/pkg/runtime/string.goc"
String 
...
#line 83 "/home/pi/go_build/go/src/pkg/runtime/string.goc"
Slice 
runtime·gobytes ( byte *p , intgo n ) 
{ 
Slice sl; 
#line 88 "/home/pi/go_build/go/src/pkg/runtime/string.goc"
...
#line 95 "/home/pi/go_build/go/src/pkg/runtime/string.goc"
String 
...
#line 105 "/home/pi/go_build/go/src/pkg/runtime/string.goc"
void 
...
#line 112 "/home/pi/go_build/go/src/pkg/runtime/string.goc"
String 
...
byte buf[8]; 
String s; 
#line 119 "/home/pi/go_build/go/src/pkg/runtime/string.goc"
n1 = 0; 
for ( i=0; str[i]; i++ ) 
...
n2 = 0; 
for ( i=0; str[i]; i++ ) { 
#line 126 "/home/pi/go_build/go/src/pkg/runtime/string.goc"
if ( n2 >= n1 ) 
break; 
...
#line 135 "/home/pi/go_build/go/src/pkg/runtime/string.goc"
String 
...
#line 151 "/home/pi/go_build/go/src/pkg/runtime/string.goc"
static String 
concatstring ( intgo n , String *s ) 
{ 
intgo i , l , count; 
String out; 
#line 157 "/home/pi/go_build/go/src/pkg/runtime/string.goc"
l = 0; 
count = 0; 
for ( i=0; i<n; i++ ) { 
if ( l + s[i].len < l ) 
...
if ( count == 1 ) 
return out; 
#line 173 "/home/pi/go_build/go/src/pkg/runtime/string.goc"
out = gostringsize ( l ) ; 
l = 0; 
for ( i=0; i<n; i++ ) { 
...
#line 185 "/home/pi/go_build/go/src/pkg/runtime/string.goc"
#pragma textflag NOSPLIT 
void 
...
#line 204 "/home/pi/go_build/go/src/pkg/runtime/string.goc"
int32 
runtime·strcmp ( byte *s1 , byte *s2 ) 
{ 
uintptr i; 
byte c1 , c2; 
#line 210 "/home/pi/go_build/go/src/pkg/runtime/string.goc"
for ( i=0;; i++ ) { 
c1 = s1[i]; 
c2 = s2[i]; 
if ( c1 < c2 ) 
...
#line 222 "/home/pi/go_build/go/src/pkg/runtime/string.goc"
byte* 
runtime·strstr ( byte *s1 , byte *s2 ) 
{ 
byte *sp1 , *sp2; 
#line 227 "/home/pi/go_build/go/src/pkg/runtime/string.goc"
if ( *s2 == 0 ) 
return s1; 
for ( ; *s1; s1++ ) { 
if ( *s1 != *s2 ) 
...
{
#line 261 "/home/pi/go_build/go/src/pkg/runtime/string.goc"
...
{
#line 268 "/home/pi/go_build/go/src/pkg/runtime/string.goc"
...
#line 320 "/home/pi/go_build/go/src/pkg/runtime/string.goc"
enum 
{ 
Runeself = 0x80 , 
} ; 
...
{
#line 346 "/home/pi/go_build/go/src/pkg/runtime/string.goc"
