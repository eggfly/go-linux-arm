...
#line 15 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
enum 
{ 
docheck = 0 , 
debug = 0 , 
...
bool eq; 
byte *k , *v; 
#line 33 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
cnt = 0; 
#line 36 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
...
#line 59 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
if ( h->oldbuckets != nil ) { 
...
#line 84 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
if ( cnt != h->count ) { 
runtime·printf ( "%D %D\n" , ( uint64 ) cnt , ( uint64 ) h->count ) ; 
runtime·throw ( "entries missing" ) ; 
} 
} 
#line 90 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
static void 
...
uint8 flags; 
#line 98 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
flags = 0; 
#line 101 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
keysize = t->key->size; 
...
#line 119 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
...
#line 135 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
B = 0; 
while ( hint > BUCKETSIZE && hint > LOAD * ( ( uintptr ) 1 << B ) ) 
B++; 
#line 141 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
if ( checkgc ) mstats.next_gc = mstats.heap_alloc; 
if ( B == 0 ) { 
#line 144 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
buckets = nil; 
} else { 
buckets = runtime·cnewarray ( t->bucket , ( uintptr ) 1 << B ) ; 
} 
#line 150 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
h->count = 0; 
h->B = B; 
h->flags = flags; 
h->keysize = keysize; 
...
#line 167 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
static void 
...
uint8 top; 
bool eq; 
#line 182 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
b = ( Bucket* ) ( h->oldbuckets + oldbucket * h->bucketsize ) ; 
newbit = ( uintptr ) 1 << ( h->B - 1 ) ; 
#line 185 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
if ( !evacuated ( b ) ) { 
#line 189 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
...
#line 209 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
hash = h->hash0; 
t->key->alg->hash ( &hash , t->key->size , IK ( h , k ) ) ; 
if ( ( h->flags & Iterator ) != 0 ) { 
t->key->alg->equal ( &eq , t->key->size , IK ( h , k ) , IK ( h , k ) ) ; 
if ( !eq ) { 
#line 225 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
if ( ( top & 1 ) != 0 ) 
hash |= newbit; 
else 
hash &= ~newbit; 
...
#line 235 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
if ( ( hash & newbit ) == 0 ) { 
...
#line 290 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
...
#line 298 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
if ( oldbucket == h->nevacuate ) { 
h->nevacuate = oldbucket + 1; 
if ( oldbucket + 1 == newbit ) 
#line 302 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
h->oldbuckets = nil; 
} 
if ( docheck ) 
check ( t , h ) ; 
} 
#line 308 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
static void 
grow_work ( MapType *t , Hmap *h , uintptr bucket ) 
{ 
uintptr noldbuckets; 
#line 313 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
noldbuckets = ( uintptr ) 1 << ( h->B - 1 ) ; 
#line 317 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
evacuate ( t , h , bucket & ( noldbuckets - 1 ) ) ; 
#line 320 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
if ( h->oldbuckets != nil ) 
evacuate ( t , h , h->nevacuate ) ; 
} 
#line 324 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
static void 
...
byte *new_buckets; 
uint8 flags; 
#line 332 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
if ( h->oldbuckets != nil ) 
...
if ( ( h->flags & Iterator ) != 0 ) 
flags |= OldIterator; 
#line 342 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
h->B++; 
h->flags = flags; 
h->oldbuckets = old_buckets; 
h->buckets = new_buckets; 
h->nevacuate = 0; 
#line 350 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
if ( docheck ) 
check ( t , h ) ; 
} 
#line 356 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
static byte* 
...
bool eq; 
byte *k , *k2 , *v; 
#line 368 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
key = *keyp; 
if ( docheck ) 
check ( t , h ) ; 
if ( h->count == 0 ) 
...
#line 471 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
static void 
...
byte *k , *v; 
byte *kmem , *vmem; 
#line 486 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
if ( docheck ) 
check ( t , h ) ; 
hash = h->hash0; 
t->key->alg->hash ( &hash , t->key->size , key ) ; 
...
#line 493 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
again: 
bucket = hash & ( ( ( uintptr ) 1 << h->B ) - 1 ) ; 
if ( h->oldbuckets != nil ) 
...
if ( !eq ) 
continue; 
#line 518 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
...
#line 530 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
if ( h->count >= LOAD * ( ( uintptr ) 1 << h->B ) && h->count >= BUCKETSIZE ) { 
hash_grow ( t , h ) ; 
goto again; 
} 
#line 535 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
if ( inserti == nil ) { 
#line 537 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
if ( checkgc ) mstats.next_gc = mstats.heap_alloc; 
...
#line 546 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
if ( ( h->flags & IndirectKey ) != 0 ) { 
if ( checkgc ) mstats.next_gc = mstats.heap_alloc; 
...
#line 566 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
static void 
...
byte *k , *v; 
bool eq; 
#line 577 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
if ( docheck ) 
check ( t , h ) ; 
if ( h->count == 0 ) 
return; 
...
if ( !eq ) 
continue; 
#line 598 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
if ( ( h->flags & IndirectKey ) != 0 ) { 
* ( byte** ) k = nil; 
} else { 
...
#line 609 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
b->tophash[i] = Empty; 
h->count--; 
#line 614 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
if ( docheck ) 
check ( t , h ) ; 
return; 
} 
...
#line 628 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
static void 
hash_iter_init ( MapType *t , Hmap *h , Hiter *it ) 
{ 
uint32 old; 
#line 633 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
if ( sizeof ( Hiter ) / sizeof ( uintptr ) != 10 ) { 
runtime·throw ( "hash_iter size incorrect" ) ; 
} 
it->t = t; 
it->h = h; 
#line 640 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
it->B = h->B; 
it->buckets = h->buckets; 
#line 644 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
it->bucket = 0; 
it->offset = runtime·fastrand1 ( ) & ( BUCKETSIZE - 1 ) ; 
it->done = false; 
it->bptr = nil; 
#line 651 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
for ( ;; ) { 
old = h->flags; 
...
#line 659 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
if ( h->buckets == nil ) { 
#line 662 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
it->done = true; 
} 
} 
#line 668 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
static void 
hash_next ( Hiter *it ) 
{ 
Hmap *h; 
...
byte *k , *v; 
byte *rk , *rv; 
#line 682 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
h = it->h; 
t = it->t; 
bucket = it->bucket; 
b = it->bptr; 
...
#line 689 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
next: 
if ( b == nil ) { 
if ( it->done ) { 
#line 693 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
it->key = nil; 
it->value = nil; 
return; 
} 
if ( h->oldbuckets != nil && it->B == h->B ) { 
#line 702 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
...
if ( check_bucket >= 0 ) { 
#line 734 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
t->key->alg->equal ( &eq , t->key->size , IK ( h , k ) , IK ( h , k ) ) ; 
if ( eq ) { 
#line 738 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
hash = h->hash0; 
t->key->alg->hash ( &hash , t->key->size , IK ( h , k ) ) ; 
...
#line 751 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
...
#line 758 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
it->key = IK ( h , k ) ; 
it->value = IV ( h , v ) ; 
} else { 
#line 763 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
t->key->alg->equal ( &eq , t->key->size , IK ( h , k ) , IK ( h , k ) ) ; 
if ( eq ) { 
#line 770 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
rk = IK ( h , k ) ; 
...
#line 781 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
it->key = IK ( h , k ) ; 
it->value = IV ( h , v ) ; 
} 
} 
...
{
#line 801 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"

	ret = typ != nil && typ->alg->hash != runtime·nohash;
	FLUSH(&ret);
}

#line 805 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
static Hmap* 
makemap_c ( MapType *typ , int64 hint ) 
{ 
Hmap *h; 
Type *key; 
#line 811 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
key = typ->key; 
#line 813 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
if ( sizeof ( Hmap ) > 48 ) 
runtime·panicstring ( "hmap too large" ) ; 
#line 816 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
if ( hint < 0 || ( int32 ) hint != hint ) 
runtime·panicstring ( "makemap: size out of range" ) ; 
#line 819 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
if ( key->alg->hash == runtime·nohash ) 
runtime·throw ( "runtime.makemap: unsupported map key type" ) ; 
#line 822 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
h = runtime·cnew ( typ->hmap ) ; 
hash_init ( typ , h , hint ) ; 
#line 828 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
if ( debug ) { 
runtime·printf ( "makemap: map=%p; keysize=%p; valsize=%p; keyalg=%p; valalg=%p\n" , 
h , key->size , typ->elem->size , key->alg , typ->elem->alg ) ; 
} 
#line 833 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
return h; 
} 
void
runtime·makemap(MapType* typ, int64 hint, Hmap* ret)
{
#line 836 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
...
{
#line 840 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
...
{
#line 847 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
...
{
#line 874 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
...
{
#line 907 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
...
{
#line 916 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
...
{
#line 940 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
...
{
#line 961 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
...
{
#line 984 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
...
{
#line 1003 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
...
{
#line 1023 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
...
{
#line 1029 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
...
{
#line 1043 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
...
{
#line 1047 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
...
{
#line 1052 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
...
#line 1063 "/home/pi/go_build/hg/go/src/pkg/runtime/hashmap.goc"
